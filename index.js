...
function searchCountries(query) {
  ...
  // For example, you might filter the countriesData array based on the query
  return countriesData.filter(country => country.name.toLowerCase().includes(query.toLowerCase()));
}
for (let i of countriesData) {

  const countriesTemp = document.querySelector(".countries-temp")
  var countriesCard = document.createElement("div")
  countriesCard.className = "countries-cards"
  countriesTemp.appendChild(countriesCard)

  var newImage = document.createElement('img');

  newImage.src = i.flags.svg
  countriesCard.appendChild(newImage)

  var countryName = document.createElement('h4');

  countryName.innerText = i.name
  countriesCard.appendChild(countryName)

  var countryCapital = document.createElement('p');

  countryCapital.innerText = "Capital: " + i.capital
  countriesCard.appendChild(countryCapital)

  var countryRegion = document.createElement('p');
  countryRegion.innerText = "Region: " + i.region
  countriesCard.appendChild(countryRegion)

  var Favouritebutt = document.createElement('button')
  Favouritebutt.innerText = "Favourite"
  countriesCard.appendChild(Favouritebutt)
}
